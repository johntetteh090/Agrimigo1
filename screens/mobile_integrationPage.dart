...
class MobileIntegrationPage extends StatelessWidget{

  final String subTitle=' Get access to your farm using '+
      'your mobile phone. Command and control your farm smartly.'+
      'It allows you to be in the field and the farm at the same time.';
  @override
                        ...
                        FlatButton(
                          ...
                          onPressed: (){
                            ...
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => SmartIrrigationPage()));
                          },
                        ),
                        SizedBox(width:30.0),
                      ],
